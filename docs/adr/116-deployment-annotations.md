...
Migration: `migrations/00288_deployments_annotation.sql`, slot 00288
(next free above 00287). Replaces the `00288_reserve_slot.sql` fence
...
```sql
-- migrations/00288_deployments_annotation.sql
