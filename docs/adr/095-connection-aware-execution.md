...
- `migrations/00219_reserve_slot.sql` (fence — this PR)
- `migrations/00219_data_upstreams.sql` (PR-A — real DDL, drops the fence file)
...
- Slot fence discipline — migration 00219 lands as
  `00219_data_upstreams.sql` at PR-A merge base, fence file
