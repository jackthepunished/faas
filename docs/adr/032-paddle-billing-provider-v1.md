# ADR-032 · Paddle as an opt-in billing provider (post-Stripe) — v1, superseded

- **Status:** superseded by [ADR-032 v2](032-paddle-billing-provider.md)
  (2026-08-18). v1 is preserved here as historical reference; the v2 ADR
  flips the standing decision to Paddle as the production billing provider.
- **Date:** 2026-07-24
- **Supersedes:** none
