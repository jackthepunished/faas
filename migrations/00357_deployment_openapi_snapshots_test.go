...
// Migration-apply test for 00357_deployment_openapi_snapshots.sql
...
func TestMigrations_00357_DeploymentOpenAPISnapshots(t *testing.T) {
	...
	if !tableExists {
		t.Fatalf("deployment_openapi_snapshots missing (00357 must create it)")
	}
