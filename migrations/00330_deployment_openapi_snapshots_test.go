...
// Migration-apply test for 00330_deployment_openapi_snapshots.sql
...
func TestMigrations_00330_DeploymentOpenAPISnapshots(t *testing.T) {
	...
	if !tableExists {
		t.Fatalf("deployment_openapi_snapshots missing (00330 must create it)")
	}
