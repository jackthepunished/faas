...
// Migration-apply test for 00431_operator_intents.sql
// (ADR-127 / PR #1099 P2 redesign step 1).
//
// Pins:
//
//  1. Migration set applies cleanly through 00431 (no goose
...
func TestMigrations_00431_OperatorIntents(t *testing.T) {
