...
-- 00214_app_secrets_scope.sql — ADR-092 / Phase 4 of the
...
-- 00213_deployments_scope.sql:69-70): every pre-00214 row gets
...
--   - this migration (sealed secrets, slot 00214)
--
...
--
-- Cross-PR slot gate: PR-A claims slot 00214 — the next free
...
--   git ls-tree origin/main migrations/ | grep '^00214'
