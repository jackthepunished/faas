...
// Migration-apply test for 00314_deployment_openapi_snapshots.sql
...
func TestMigrations_00314_DeploymentOpenAPISnapshots(t *testing.T) {
	...
	if !tableExists {
		t.Fatalf("deployment_openapi_snapshots missing (00314 must create it)")
	}
