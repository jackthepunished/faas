...
// Migration-apply test for 00200_app_envs_scope.sql
// (ADR-090 PR-A / multi-scope app envs).
//
// Pins:
//
//  1. Migration set applies cleanly through 00200 (no goose
//     duplicate-version panic). PR-A carries reservation fences at
//     00198 and 00199 (matching files in this directory) to satisfy
//     TestMigrationsContiguous on the branch tip. The renumber
//     chain was 00198 → 00199 → 00200 as PR #819 and PR #826
//     claimed the earlier slots (see migrations/00200_app_envs_scope.sql
...
//     pre-00200 row gets scope='default' lazily on first read/write
...
func TestMigrations_00200_AppEnvsScope(t *testing.T) {
