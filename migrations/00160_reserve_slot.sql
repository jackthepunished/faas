...
--
-- 00160_reserve_slot.sql — slot reservation placeholder
...
-- 00162_deployments_live_traffic_idx, which is on main). This 160
-- fence holds the slot open for any sibling PR that wants 160
