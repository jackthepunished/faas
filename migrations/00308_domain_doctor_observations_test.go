...
// Migration-apply test for 00308_domain_doctor_observations.sql
...
func TestMigrations_00308_DomainDoctorObservations(t *testing.T) {
	...
	if !tableExists {
		t.Fatalf("domain_doctor_observations missing (00308 must create it)")
	}
