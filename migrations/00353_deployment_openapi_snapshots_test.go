...
// Migration-apply test for 00353_deployment_openapi_snapshots.sql
...
func TestMigrations_00353_DeploymentOpenAPISnapshots(t *testing.T) {
	...
	if !tableExists {
		t.Fatalf("deployment_openapi_snapshots missing (00353 must create it)")
	}
