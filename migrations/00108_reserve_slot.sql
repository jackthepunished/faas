...
--
-- 00108_reserve_slot.sql — slot reservation placeholder
...
--
-- Slot 108 is held by open PR #532 (issue #517 PR-D — jailer /
...
-- 00107_events_wake_id_idx.sql so the embedded set stays
-- contiguous from 1 through 108.
--
-- Whichever side lands first (PR-C with the 107 real migration
-- + 108 reservation, or PR-D with its real 107/108 migrations),
-- the other drops its reservation on rebase. The cross-PR slot
