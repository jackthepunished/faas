...
// Migration-apply test for 00305_domain_doctor_observations.sql
...
func TestMigrations_00305_DomainDoctorObservations(t *testing.T) {
	...
	if !tableExists {
		t.Fatalf("domain_doctor_observations missing (00305 must create it)")
	}
