...
--
-- 00089_reserve_slot.sql — slot reservation placeholder
...
--
-- Slot 89 is held by open PR #525 (Tier 3 warm-snapshot) as a
-- REAL migration (snapshots_tier). See 00088_reserve_slot.sql for
-- the full carve-out rationale; the same body shape applies here.
--
