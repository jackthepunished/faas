...
-- filename: 00091_apps_node_claimable.sql
--
-- Phase 2 / Gate A — schedd-side async placement claim.
--
-- Pre-00091 apps.node_id was NOT NULL: the apid createApp handler
...
-- 00090 backfill guarantees all pre-00091 rows have a real
-- node_id, and post-00091 every new row is stamped by schedd
-- before the down could be exercised). The
-- migrations/00091_apps_node_claimable_test.go suite pins this
-- behaviour.
