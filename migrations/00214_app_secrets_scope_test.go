...
// Migration-apply test for 00214_app_secrets_scope.sql
// (ADR-092 PR-A / Phase 4 scope-aware sealed secrets).
//
// Pins:
//
//  1. Migration set applies cleanly through 00214 (no goose
//     duplicate-version panic). Slot 00214 was the next free slot
...
//     pre-00214 row gets scope='default' lazily on first read/write
...
func TestMigrations_00214_AppSecretsScope(t *testing.T) {
	...
	// column list is the pre-00214 shape: PK was (app_id, key),
