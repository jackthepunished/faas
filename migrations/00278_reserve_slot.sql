...
-- goose "duplicate version 278" collision if PR #910's triggers
-- cluster (issue #757 / ADR-100) tries to renumber onto 278 — and
...
--
-- This file is a no-op. The next migration PR to claim 00278 will
