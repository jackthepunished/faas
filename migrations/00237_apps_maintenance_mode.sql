-- filename: 00237_apps_maintenance_mode.sql
-- +goose Up
...
-- (since renumbered to migration 00237 by PR-B's 8-cycle renumber;
-- 00227 is now a fence on main owned by the kind=geo cluster
-- (PR #845) — the 00226/00227/00228 stampede is settled by
-- stepping this migration to 00237; 00232 is reserved by PR #864
-- ADR-093 request budgets (earlier renumber); 00233 by PR #873
-- secretscan v2; 00234 by PR #864 (after PR #872 reshape).
