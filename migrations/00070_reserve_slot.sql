...
--
-- 00070_reserve_slot.sql — slot reservation placeholder
...
-- usage_minutes schema, ADR-048) had already claimed slot 70 with
-- migrations/00070_snapshot_storage_daily.sql. Without this
-- reservation at 70, the branch's embedded FS would have a gap
-- and TestMigrationsContiguous would fail at PR time.
--
-- PR #428 already carries its own 00070_snapshot_storage_daily.sql
