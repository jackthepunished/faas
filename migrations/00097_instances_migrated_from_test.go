...
// Migration-apply tests for 00097 (instances.migrated_from_node_id +
...
// TestMigration_00097_1_ColumnShape pins the schema of the
// three new instances columns after 00097 applies. A regression
...
func TestMigration_00097_1_ColumnShape(t *testing.T) {
...
// TestMigration_00097_2_AllowsNull pins the never-migrated
...
func TestMigration_00097_2_AllowsNull(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00097_3_AllowsPastTimestamp pins the normal
...
func TestMigration_00097_3_AllowsPastTimestamp(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00097_4_RejectsFutureTimestamp pins the
...
// the future.
func TestMigration_00097_4_RejectsFutureTimestamp(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00097_5_FKOnDelete pins the ON DELETE SET NULL
...
func TestMigration_00097_5_FKOnDelete(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00097_6_PartialIndex pins the partial-index
...
func TestMigration_00097_6_PartialIndex(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00097_7_ReplaySafe pins the idempotency
...
func TestMigration_00097_7_ReplaySafe(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
...
// TestMigration_00097_8_DownSymmetry pins the down path.
...
// schema on a release that needs to roll back 00097 in
// isolation.
func TestMigration_00097_8_DownSymmetry(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
