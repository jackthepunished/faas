-- filename: 00254_edge_rules_kind_budget.sql
-- +goose Up
...
-- pre-existing-vocab walk loop in 00254's test, or the test will
...
--
-- Slot choice: 00254 is the lowest unclaimed slot after main's
