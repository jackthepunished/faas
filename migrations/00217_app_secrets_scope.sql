...
-- 00217_app_secrets_scope.sql — ADR-092 / Phase 4 of the
...
-- 00213_deployments_scope.sql:69-70): every pre-00217 row gets
...
--   - this migration (sealed secrets, slot 00217)
--
...
--
-- Cross-PR slot gate: PR-A claims slot 00217 — the next free
-- slot on main after PR-826 (`00215_compute_node_heartbeats_stats`)
-- and PR-844 (`00216_apps_route_metrics_enabled`, ADR-093) both
-- landed before PR-A's slot-chase re-run on 2026-08-11. No sibling
-- PRs are currently contesting this slot. Pre-merge verify with
--   git ls-tree origin/main migrations/ | grep '^00217'
