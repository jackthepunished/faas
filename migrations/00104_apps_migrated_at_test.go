...
// Migration-apply tests for 00104 (apps.migrated_at +
...
// TestMigration_00104_1_ColumnShape pins the schema of the
// new apps.migrated_at column after 00104 applies. A
...
// migrated).
func TestMigration_00104_1_ColumnShape(t *testing.T) {
...
// TestMigration_00104_2_AllowsNull pins the never-migrated
...
func TestMigration_00104_2_AllowsNull(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00104_3_AllowsPastTimestamp pins the normal
...
func TestMigration_00104_3_AllowsPastTimestamp(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00104_4_RejectsFutureTimestamp pins the
...
func TestMigration_00104_4_RejectsFutureTimestamp(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
	migrateUpOnce(ctx, t, pool)
...
// TestMigration_00104_5_ReplaySafe pins the idempotency
...
func TestMigration_00104_5_ReplaySafe(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
...
// TestMigration_00104_6_DownSymmetry pins the down path.
...
// release that needs to roll back 00104 in isolation.
func TestMigration_00104_6_DownSymmetry(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)
	defer pool.Close()
