-- filename: 00228_apps_maintenance_mode.sql
-- +goose Up
...
-- (since renumbered to migration 00228 by PR-B's 5-cycle renumber;
-- 00227 is no longer the apps.maintenance_mode slot — see
-- harness.go::e2eMigrationTarget for the chain).
