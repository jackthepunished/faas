...
--
-- 00279_reserve_slot.sql — slot reservation placeholder
...
--
-- Context: slot 00279 is claimed by open PR #910
-- (triggers_poison_strategy). PR #829 is junior on 00279. The
-- branch tip carries this 00279 fence so TestMigrationsContiguous
-- stays green until PR #910 lands. When #910 lands, this fence
-- becomes a duplicate-version collision and must be removed in a
-- follow-up commit on PR #829.
--
