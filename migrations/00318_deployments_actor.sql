...
-- filename: 00318_deployments_actor.sql
--
...
--
--   00318 (this migration): ADD CONSTRAINT … NOT VALID — adds
...
--
--   00319: VALIDATE CONSTRAINT deployments_deployed_by_user_id_fk
...
-- +goose Down
-- +goose StatementBegin
-- Note: VALIDATE in 00319 is forward-only; on full Down we DROP
-- the FK first (in case 00319 was applied) then drop the column.
