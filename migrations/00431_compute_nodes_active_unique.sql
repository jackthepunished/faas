-- filename: 00431_compute_nodes_active_unique.sql
-- +goose Up
-- +goose StatementBegin
--
-- 00431_compute_nodes_active_unique.sql — multi-host safety cluster PR-4
...
-- name is not.
--
-- Note on slot numbering: PR-4 originally branched off main at
-- post-00346 (PR #1015 / c5269bd8d) and claimed slot 00347.
-- Sibling multi-host-safety-cluster PRs (#1019 / #1030 / #1034)
-- and a flood of #1006 safe-releases mega fences consumed
-- 00347..00375 on main; PR #1023 (ADR-124 app_protocol) claimed
-- 00376-00382; PR #1019 (mirror) claimed 00383-00386; PR #1046
-- (openapi-import) claimed 00383; PR #1017 (alert-presets) filled
-- 00387-00390 with bridges. PR #1049 (openapi-import rebump) and
-- #1070 (wake-failure) absorbed 00391-00416. PR-4 was renumbered to
-- 00431 (after a first hop to 00417) because PR #1017's alert-presets
-- catalog rebump now claims 00417-00420 — gateway collision; see
-- memory cross-pr-slot-precheck-pr-867-collision-2026-08-13. The
-- migration slot-dance runbook referenced historically in this file
-- (docs/runbooks/migration-slot-dance.md) is not on this branch. See
-- docs/runbooks/migration-slot-dance.md.
--
-- The CREATE INDEX references `compute_nodes(name)` with no
-- schema qualifier so the index lands on whatever schema the
-- migration runner's search_path resolves — preserves the
-- per-test schema isolation under pgtest, which sets
