...
// Migration-apply test for 00168_app_secrets_kid.sql
// (ADR-089 PR-A / per-secret rotation surface).
//
// Pins:
//
//  1. Migration set applies cleanly through 00168 (no goose
...
func TestMigrations_00170_AppSecretsKid(t *testing.T) {
	...
	// 00168 have no kid recorded; the migration's best-effort
