...
-- filename: 00314_deployments_actor.sql
--
...
--
--   00314 (this migration): ADD CONSTRAINT … NOT VALID — adds
...
--
--   00315: VALIDATE CONSTRAINT deployments_deployed_by_user_id_fk
...
-- +goose Down
-- +goose StatementBegin
-- Note: VALIDATE in 00315 is forward-only; on full Down we DROP
-- the FK first (in case 00315 was applied) then drop the column.
