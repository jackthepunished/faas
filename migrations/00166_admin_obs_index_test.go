...
// Migration-apply test for 00166_admin_obs_index.sql
...
// TestMigrations_00166_AdminObsIndex pins the four indexes
// declared in 00166_admin_obs_index.sql. One row per expected
...
func TestMigrations_00166_AdminObsIndex(t *testing.T) {
