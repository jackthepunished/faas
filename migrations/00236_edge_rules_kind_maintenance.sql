-- filename: 00236_edge_rules_kind_maintenance.sql
-- +goose Up
...
-- branch re-merges. This migration is renumbered to 00236 (was
-- 00234 in the previous step, 00231 in the step before, 00227 in
-- earlier cycles) so the chain is:
--
--   00219 kind=limit → 00229 kind=geo → 00236 kind=maintenance
--
...
-- (since renumbered to migration 00236 by PR-B's 8-cycle renumber;
-- 00227 is now a fence on main owned by the kind=geo cluster;
-- 00234 is reserved by PR #864 ADR-093 request budgets after the
-- PR #872 reshape; 00233 by PR #873 secretscan v2; 00232 by
-- PR #864 earlier renumber; 00231 by PR #873 secretscan v2
-- earlier renumber).
