-- filename: 00153_reserve_slot.sql
-- Slot 153 — claimed by issue #554 (Liveness probe — restart a wedged VM;
...
-- that migration; claim slot 154 next, do NOT back-fill this fence.
--
-- Slot note: the highest open slot on the local branch is 148 — issue
-- #561's fence (migrations/00148_overage_cap_gate_index.sql). Slot 153
