...
// Migration-apply test for 00326 (ADR-118 — per-app ingress IP
// allowlist, extends apps.public_auth_mode with 'ip_allowlist').
// Pins the contract:
//
//   1. The migration set applies cleanly through 00326.
...
func TestMigrations_00326_AppPublicAuthIPAllowlist(t *testing.T) {
	ctx := context.Background()
	pool := pgtest.Open(t)

	// (1) Apply through 00326.
	...
	if _, err := pool.Exec(ctx, `
		...
		values ('00000000-0000-0000-0000-000000000326',
