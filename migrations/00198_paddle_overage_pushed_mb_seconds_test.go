...
// Apply-walk + column-shape test for migration 00198
...
func TestMigrations_00198_PaddleOveragePushedMBSeconds(t *testing.T) {
	...
	acctID := "acct-mig-00198-" + time.Now().UTC().Format("150405.000000000")
