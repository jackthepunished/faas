...
-- from 00233 (a candidate intermediate slot) → 00234/00235 after
-- the cross-PR collision detector rejected slot 00233 (claimed by
-- open PR #873 secretscan v2) alongside slots 00231 (PR #873) and
-- 00232 (PR #864 ADR-093 reqbudget). See the doc-comment block on
