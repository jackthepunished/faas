...
// Shape test for migration 00060 (issue #396 / ADR-045) —
...
func TestMigrations_00060_AlertRules_ShapeAndFK(t *testing.T) {
	...
	const (
		acctID    = "00000000-0000-0000-0000-000000000060"
