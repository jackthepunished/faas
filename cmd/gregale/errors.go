...
var errorDocsURL = map[string]string{
	...
	api.CodePlanTrafficSplitNotAllowed: docsURLPrefix + "/plans/traffic-split",
	api.CodeInvalidTrafficPercent:      docsURLPrefix + "/deployments/traffic-percent",
	api.CodeTrafficPercentSumInvalid:   docsURLPrefix + "/deployments/traffic-percent",
