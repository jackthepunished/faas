...
var runtimeConfigCatalog = []runtimeConfigDefinition{
	...
	{Key: "billing_provider", Label: "Billing provider", Description: "Provider selection is changed through a rolling deployment with credential preflight.", Category: "Billing", Kind: "enum", Default: json.RawMessage(`"paddle"`), ApplyMode: state.RuntimeConfigApplyRolling, Mutable: false},
