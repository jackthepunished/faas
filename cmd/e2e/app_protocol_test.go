...
// constraint (migration 00347). PR-B / G19 ships the bridge-side
...
// → migration 00347 column → GET /v1/apps/{slug} response).
...
// CHECK constraint (migration 00347) is the only thing
