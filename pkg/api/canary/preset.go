...
// deployments_canary_preset_chk DB constraint at migration 00480.
// Order matches the catalog above so the dashboard renders the
// ladder selector in a stable order.
