...
type CreateJobRequest struct {
	...
	// by migrations/00529 jobs_command_min_chk.
	Command []string `json:"command"`
	...
	// RAMMB is the billable memory (migrations/00528 +
	// 00529 jobs_command.sql + per-plan caps). 0 →
...
// dead_letter_count (added in migrations/00531) is the
