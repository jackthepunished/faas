...
// step with scanJobCols and the migrations 00255 + 00526 DDL. The
// command column (00526) is the last entry so the SELECT list reads
// in schema-add order.
...
// Includes dead_letter_count (00528). ORDER BY id keeps the contract
...
// Includes exit_code + next_attempt_at (00525), lease_token +
// lease_expires_at + last_lease_node (00528). The dispatch-tick
