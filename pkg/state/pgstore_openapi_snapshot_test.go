...
// (ADR-121, migration 00352). The migration-pinned schema is
// verified by migrations/00352_deployment_openapi_snapshots_test.go;
...
// are uuid (migration 00352), so the "missing" lookups use a
...
// DESC) index added in migration 00352 backs the lookup.
