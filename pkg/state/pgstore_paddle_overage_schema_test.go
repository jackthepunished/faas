...
// path: after migrations 00034 + 00041 + 00209 apply, the probe
...
func TestPgStorePaddleOverageDedupeSchema_PostApply(t *testing.T) {
	...
	if !res.TableExists {
		t.Errorf("TableExists = false post-apply, want true (migrations 00034 + 00041 + 00209 must have created paddle_overage_dedupe)")
	}
