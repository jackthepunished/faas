...
// post-stream summary (ADR-117, migration 00296). Distinct from
...
// (migrations/00296_deployments_stage_state.sql) enforces the same
...
// migrations/00296 jsonb CHECK constraint AND the wire-shape test
...
type Deployment struct {
	...
	// StageState (ADR-117, migration 00296) — per-deployment
