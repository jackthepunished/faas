...
// post-stream summary (ADR-117, migration 00288). Distinct from
...
// (migrations/00288_deployments_stage_state.sql) enforces the same
...
// migrations/00288 jsonb CHECK constraint AND the wire-shape test
...
type Deployment struct {
	...
	// StageState (ADR-117, migration 00288) — per-deployment
