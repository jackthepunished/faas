...
func Roles() []Role {
	...
	serverRoles := []Role{
		...
		{CommonName: "gatewayd.faas", Kind: KindServer, Directory: "gatewayd", Filename: "egress", AltNames: ProductionSANs("gatewayd.faas")},
	...
	clientRoles := []Role{
		...
		{CommonName: "meterd.faas", Kind: KindClient, Directory: "meterd", Filename: "gatewayd-egress-client", AltNames: ProductionSANs("meterd.faas")},
