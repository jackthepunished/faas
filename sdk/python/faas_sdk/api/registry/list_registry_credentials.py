...
from ...models.app_registry_credential_list_response import AppRegistryCredentialListResponse
...
) -> AppRegistryCredentialListResponse | Problem | None:
    if response.status_code == 200:
        response_200 = AppRegistryCredentialListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppRegistryCredentialListResponse | Problem]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AppRegistryCredentialListResponse | Problem
    """
