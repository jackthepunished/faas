...
from ...models.mirror_rule_list_response import MirrorRuleListResponse
...
) -> MirrorRuleListResponse | Problem | None:
    if response.status_code == 200:
        response_200 = MirrorRuleListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[MirrorRuleListResponse | Problem]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        MirrorRuleListResponse | Problem
    """
